...
- [ ] T008 Add shared-domain guardrail check for `src/NetworkMonitoring.Domain/SeedWork`
      (no file changes except `NetworkMonitoring.Domain.csproj` and `GlobalUsings.cs`)
