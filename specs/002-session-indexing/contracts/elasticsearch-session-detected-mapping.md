...
- Reference index (via connector `topic.to.external.resource.mapping`): `sessions-detected` (see infrastructure/connectors/elasticsearch-sink-sessions-detected.json`).  
